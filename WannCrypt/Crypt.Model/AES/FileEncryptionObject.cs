// |+|-------------------------YB7IQX-------------------------|+|
// <copyright file="FileEncryptionObject.cs" company="ITSec midterm project">
...
namespace Crypt.Model.AES
{
    ...
    /// <summary>
    /// Model that is resposible of storing the data regarding a file that is being encrypted.
    /// </summary>
    public class FileEncryptionObject : IAESObject, IEncryptionObject, IFileObject
    {
